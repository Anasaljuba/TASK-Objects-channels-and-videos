...
function channelHasVideo(videoTitle, channel) {
  // Your code here
  return channel.videos.some(check=> check.title===videoTitle)
}
...
function getChannelByName(channelName, channels) {
  // Your code here
  return  channels.find(channelCheck => channelCheck.name === channelName)
}
...
function getChannelByVideoTitle(videoTitle, channels) {
  // Your code here
  return channels.find(chan => chan.videos.some(chani => chani.title===videoTitle))
}
...
function searchChannels(query, channels) {
  // Your code here
  return  channels.filter(check => {
    return check.description.includes(query) || check.name.includes(query)
  }
